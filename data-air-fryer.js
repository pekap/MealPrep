...
const f = {
  ...
  nuggets: v("/frames/air-nuggets-460.jpg", 460, "Mike and Carly tasting the chicken nuggets"),
...
export const airFryerPlan = {
  ...
  copy: "All seven savory freezer recipes from Mike’s air-fryer video, prepped once and cooked straight from frozen on demand.",
  ...
  formula: [[7, "Mike G freezer builds"], [1, "overnight freeze"], [1, "air fryer"], [0, "weekday pans"]],
  ...
  aside: {
    ...
    copy: "Mike’s mold-and-bag method makes each component individually portionable. The week has almost no weekday cleanup.",
  ...
  meals: [
    ["MON", "17", m("Chicken nuggets + crunch", ["nuggets", "slaw", "dip"], "Mike’s food-processor chicken nuggets with cabbage-cucumber crunch and dip.", "Spray and air-fry from frozen at 350°F for 9–10 min.", f.nuggets), m("Steak + bean burrito", ["steak", "beans", "cheddar"], "Skirt steak, corn, black beans, and cheddar in a crisp tortilla.", "Air-fry from frozen at 350°F for 10–15 min.", f.burrito)],
    ["TUE", "18", m("Falafel pita plate", ["falafel", "pita", "hummus"], "Mike’s parsley falafel with pita, hummus, cucumber, and lemon.", "Spray and air-fry from frozen at 380°F for 10 min.", f.falafel), m("Cheesy polenta + salad", ["polenta", "mozzarella", "tomato"], "Tomato-and-mozzarella stuffed polenta with a simple green salad.", "Air-fry at 380°F for 10 min per side.", f.polenta)],
    ...
    ["THU", "20", m("Nugget wrap", ["nuggets", "tortilla", "slaw"], "Air-fried nuggets sliced into a tortilla with slaw and yogurt sauce.", "Air-fry at 350°F for 9–10 min; warm tortilla in the final minute.", f.nuggets), m("Homemade pizza rolls", ["dough", "pepperoni", "mozzarella"], "Mike’s from-scratch freezer pizza rolls with a dressed salad.", "Air-fry from frozen at 380°F for 10 min.", f.pizza)],
  ...
  timeline: [
    ...
    ["2:25", "Bread, freeze, label", "Bread firm nuggets. Freeze everything solid, then bag with Mike’s time and temperature."],
  ],
  recipes: [
    ["Tater tots", "AIR FRY", "Mike’s one-ingredient freezer tot.", ["4 large russets", "oil spray"], ["Boil halved potatoes 10–15 min; cool, peel, and grate.", "Press firmly into molds and freeze overnight.", "Spray; air-fry at 360°F for 18 min."], 38],
    ...
    ["Pizza rolls", "AIR FRY", "Mike’s from-scratch freezer pizza roll.", ["550 g flour", "225 g water", "2 tsp yeast", "12 g salt", "tomato sauce", "mozzarella + pepperoni"], ["Mix, knead, and rest dough overnight.", "Roll two sheets; add filling, egg-wash seams, top, cut, vent, and freeze.", "Air-fry at 380°F for 10 min."], 1027],
  ],
  shopping: [
  ...
  methodNote: "This plan uses every savory recipe in Mike’s freezer-to-air-fryer video. French toast sticks are the only omission because you requested lunch and dinner only. Recipe text is paraphrased from Mike’s public document; time and temperature targets are preserved.",
};
